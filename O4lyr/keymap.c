...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [4] = LAYOUT_moonlander(
    TO(0),          TO(1),          TO(2),          TO(3),          KC_TRANSPARENT, KC_TRANSPARENT, DM_REC1,                                        DM_REC2,        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
